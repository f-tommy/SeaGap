...
"""
function kinematic_array(lat,TR_DEPTH=3.0; NR=3::Int64,eps=1.e-4,ITMAX=20::Int64,delta_pos=1.e-4,fn1="tr-ant.inp"::String,fn2="pxp-ini.inp"::String,fn3="ss_prof.inp"::String,fn4="obsdata.inp"::String,fno1="kinematic_array.out"::String,fno2="residual_kinematic.out"::String,fno0="log.txt"::String)
  println(stderr," === GNSS-A positioning: kinematic_array  ===")
  # --- Input check
  if TR_DEPTH < 0
    error(" kinematic_array: TR_DEPTH must be positive")
  end
  if NR < 3
  ...
  println(out0,"TR_Depth: $TR_DEPTH, Lat: $lat")
  # --- Set parameters
