...
export plot_mcmcres_all
"""
    plot_mcmcres_all(;fno,fn,plot_size,lmargin,rmargin,tmargin,bmargin,show,nshuffle,ms,lfs,tfs,bmargin0)

Make a figure of the posterior PDF and the travel-time RMS changes through the MCMC iteration using the results of `static_array_mcmc_all()` and `static_array_mcmc_all()`.
...
"""
function plot_mcmcres_all(;fno="mcmc_res.pdf"::String,fn="mcmc.out"::String,plot_size=(600,400),lmargin=3.0,rmargin=1.0, tmargin=1.0, bmargin=1.0,show=false,nshuffle=50000::Int64,ms=3::Int64,lfs=10::Int64,tfs=6::Int64,bmargin0=-1)
