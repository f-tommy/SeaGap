...
# Example
    plot_mcmcparam_sd(5,fno="mcmc_param.pdf")
"""
function plot_mcmcparam_all(NA=5::Int64; fno="mcmc_param.pdf"::String,fn="sample.out"::String,plot_size=(500,900),lmargin=6,rmargin=1.0, tmargin=1.0, bmargin=1.0,show=false::Bool,nshuffle=10000::Int64,ms=2::Int64,lfs=5::Int64,tfs=5::Int64,bmargin0=-2)
