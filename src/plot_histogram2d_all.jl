...
export plot_histogram2d_all
"""
    plot_histogram2d_sd(;fn,show,fno,plot_size,lmargin,tmargin,bmargin,rmargin,nshuffle,lfs,tfs,hm,vm,nbins,pscale)
...
# Example
    plot_histogram2d_sd(fno="histogram2d.pdf")
"""
function plot_histogram2d_all(;fn="sample.out"::String,show=false::Bool,fno="histogram2d.pdf"::String,plot_size=(750,750),lmargin=1.5,tmargin=1.0,bmargin=1.0,rmargin=1.5,nshuffle=10000::Int64,lfs=5::Int64,tfs=4::Int64,hm=-1.0,vm=-1.0,nbins=50::Int64,pscale=3)
