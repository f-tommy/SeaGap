...
export plot_histogram_all
"""
    plot_histogram_sd(NPB1, NPB2; all,drawnls,fn,fn0,fno,plot_size,lmargin,tmargin,bmargin,rmargin,nbins)
...
# Example
    plot_histogram_all(5,100,all=true,fno="histogram_all.pdf")

"""
function plot_histogram_all(NPB1=5::Int64,NPB2=100::Int64; all=false,drawnls=false,fn="sample.out"::String,fn0="solve.out"::String,fno="histogram.pdf"::String,plot_size=(650,500),lmargin=1.5,tmargin=1.0,bmargin=1.0,rmargin=1.5,nbins=50::Int64)
  ...
  if all == false
    list = ["Displacement (EW) [m]","Displacement (NS) [m]","Displacement (UD) [m]","Shallow Gradient (EW) [sec/km]","Shallow Gradient (NS) [sec/km]","Gradient Depth (EW) [sec/km]","Gradient Depth (NS) [sec/km]"]
  else
    list = ["Displacement (EW) [m]","Displacement (NS) [m]","Displacement (UD) [m]","Shallow Gradient (EW) [sec/km]","Shallow Gradient (NS) [sec/km]","Gradient Depth (EW) [sec/km]","Gradient Depth (NS) [sec/km]","HP for error","HP for S-NTD","HP for S-Grad","HP for G-Depth"]
    for i in 1:NPB1
      str0 = "L-NTD "
