...
export plot_cormap_grad

"""
    plot_cormap_grad(;txt,all,fn,fno,fno0,as,pfs,plot_size,show,lmargin,tmargin,bmargin,rmargin)
...
# Example
    plot_cormap_grad(type="all",NPB=41,as=5,fno="cormap_all.pdf")

"""
function plot_cormap_grad(;txt=false::Bool,all=false::Bool,fn="sample.out"::String,fno="cormap.pdf"::String,fno0="correlation.out"::String,as=10::Int64,pfs=8::Int64,plot_size=(600,600),show=false::Bool,lmargin=0.5,tmargin=0.5,bmargin=0.5,rmargin=4.0)
