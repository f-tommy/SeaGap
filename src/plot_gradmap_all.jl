...
"""
function plot_gradmap_all(xrange=(-3000,3000),yrange=(-3000,3000);autoscale=true::Bool,fn1="pxp-ini.inp"::String,fn2="residual_sdls.out"::String,fno="gradmap.pdf"::String,plot_size=(600,500),lmargin=2.5,tmargin=1.0,bmargin=1.0,rmargin=1.0,show=false::Bool,ms1=10::Int64,ms2=3::Int64,gfs=12::Int64,shape=:circle,cb=:lightrainbow)
